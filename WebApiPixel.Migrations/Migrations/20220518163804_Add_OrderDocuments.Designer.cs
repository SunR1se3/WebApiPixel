...
namespace WebApiPixel.Migrations.Migrations
{
    ...
    [Migration("20220518163804_Add_OrderDocuments")]
    partial class Add_OrderDocuments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiPixel.Domain.Entities.OrderDocuments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApiPixel.Domain.Entities.OrderDocuments", b =>
                {
                    b.HasOne("WebApiPixel.Domain.Entities.Order", "Order")
                        .WithOne("OrderDocuments")
                        .HasForeignKey("WebApiPixel.Domain.Entities.OrderDocuments", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_Order_OrderDocuments");
